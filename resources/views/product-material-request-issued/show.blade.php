    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Product Material Request Details Issued</h3>
            </div>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                          ...
                          @endif
                          <li>
                            <a href="/product-material-request-issued">
                                ...
                                <table class="table" style="width:100%; margin-bottom: 30px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="border: 0;">Issued By</th>
                                            <th style="border: 0;">Issued Date</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<?php
							            ...
							            $issued_date = '';
							            if($product_material_request->issued_date != '' && $product_material_request->issued_date != null) {
							                $dt2 = new DateTime($product_material_request->issued_date);
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 0;">{{$product_material_request->name}}</td>
                                            <td style="border: 0;">{{$issued_date}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                    ...
                                    <form id="update_request" method="post" action="/product-material-request-issued" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data">
		                            {!! method_field('put') !!}
                                    {!! csrf_field() !!}
