        ...
        <div class="row">
            <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form id="create_tax" method="post" action="/taxes" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="tax_name" name="tax_name" required="required" class="form-control ">
                                </div>
                            </div>
