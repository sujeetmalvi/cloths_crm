                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="display: flex;">
                                                    <a href="{{ route('shifts.edit', $shift->shift_id) }}"><button type="button" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-pencil"></i></button></a>
...
@include('template.bottom')resources/views/shifts/index.blade.php